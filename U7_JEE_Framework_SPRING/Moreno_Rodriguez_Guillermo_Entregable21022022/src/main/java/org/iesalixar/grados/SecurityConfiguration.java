package org.iesalixar.grados;

import org.iesalixar.grados.services.JPAUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/grados","/grados/asignaturas").permitAll()
		.antMatchers("/grados/*").hasRole("ADMIN")
